...
{
    [Serializable]
    public class PodporaNakupuPudy : AbstractForm
    {

        public PodporaNakupuPudy()
        {
            ...
            VymeraPudy = new VymeraPudy();
            PodnikatelskyZamer = new PodnikatelskyZamer();
            Evidence = new Evidence();
            ZemedelskaVyroba = new ZemedelskaVyroba();
        ...
        public ZemedelskaVyroba ZemedelskaVyroba { get; set; }
        public Evidence Evidence { get; set; }
        public PredmetPodnikani PredmetPodnikani { get; set; }
        public VymeraPudy VymeraPudy { get; set; }
        public PodnikatelskyZamer PodnikatelskyZamer { get; set; }
