...
{
    [Serializable]
    public class UveryPuda_ViewModel : AbstractForm
    {
        public UveryPuda_ViewModel()
        {
        ...
        public bool IsUver { get; set; }

        public bool IsSnizeni { get; set; }

        public bool Povinne { get; set; }

        [Display(GroupName = "Header", Name = "Požadovaná výše úvěru (kč)")]
        [RegularExpression("^[0-9]*$", ErrorMessage = "Nesprávná hodnota")]
        public int VyseUveru { get; set; }

        [Display(GroupName = "Header", Name = "Doba splatnosti úvěru (počet měsíců) *")]
        [RegularExpression("^[0-9]*$", ErrorMessage = "Nesprávná hodnota")]
        public int Splatnost { get; set; }
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName = "PodporaUveryPuda_ViewModel_PopisneCislo")]
        [Display(GroupName = "fyzickaOsoba", ResourceType = typeof(FormResources),
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaUveryPuda_ViewModel_TPEmail_Zadejte_kontaktní_e_mail_žadatele_KontaktniEmail")]
    ...
    ErrorMessageResourceName = "PodporaZemedelec_Povolené_znaky")]
        ...
        /*[RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaUveryPuda_ViewModel_TPUlice_Zadejte_název_ulice_trvalého_bydliště_žadatele")]*/
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", true, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaUveryPuda_ViewModel_Zadejte_kraj")]
        ...
        public bool IsUcetnictvi { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "CZNACE")]
        ...
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet1")]
        public string Ucet1 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet2")]
        public string Ucet2 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet3")]
        public string Ucet3 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet4")]
        public string Ucet4 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet5")]
        public int Ucet51 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet6")]
        public int Ucet61 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet7")]
        public int Ucet71 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet5")]
        public int Ucet52 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet6")]
        public int Ucet62 { get; set; }

        [RequiredIfFieldHasValue("IsUcetnictvi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
        Name = "Ucet7")]
        public int Ucet72 { get; set; }
        ...
        [RequiredIfFieldHasValue("RostlinnaVyroba", true, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName = "PodporaUveryPuda_ViewModel_StrukturaPestovanychPlodin_Popište_strukturu_pěstovaných_plodin")]
        [UIHint("Textarea")]
        ...
        [RequiredIfFieldHasValue("ZivocisnaVyroba", true, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName = "PodporaUveryPuda_ViewModel_StrukturaChovanychZvirat_Popište_strukturu_chovaných_zvířat")]
        [UIHint("Textarea")]
        ...
        [Display(GroupName = "DeMinimis", ResourceType = typeof(FormResources),
        Name = "DMName")]
        [RequiredIfFieldHasValue("IsDeminimis", false, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        ...
        [Display(GroupName = "DeMinimis", ResourceType = typeof(FormResources),
        Name = "DMUcetniObdobi")]
        public bool DMUcetniObdobi { get; set; }

        [RequiredIfFieldHasValue("DMUcetniObdobi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "DeMinimis", ResourceType = typeof(FormResources),
        Name = "DMUcetniObdobiZacatek")]
        [DataType(DataType.Date)]
        [DisplayFormat(DataFormatString = "{0:dd.MM.yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? DMUcetniObdobiZacatek { get; set; }

        [RequiredIfFieldHasValue("DMUcetniObdobi", true, ErrorMessageResourceType = typeof(FormResources),
        ErrorMessageResourceName = "Nevyplneno")]
        [Display(GroupName = "DeMinimis", ResourceType = typeof(FormResources),
        Name = "DMUcetniObdobiKonec")]
        [DataType(DataType.Date)]
        [DisplayFormat(DataFormatString = "{0:dd.MM.yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? DMUcetniObdobiKonec { get; set; }

        [Display(GroupName = "DeMinimis", ResourceType = typeof(FormResources),
        Name = "DMPropojen")]
        public bool DMPropojen { get; set; }
