...
{
    [Serializable]
    public class Puda_ViewModel : AbstractForm
    {
        public Puda_ViewModel()
        {
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName = "PodporaPuda_ViewModel_PopisneCislo")]
        [Display(GroupName = "fyzickaOsoba", ResourceType = typeof(FormResources),
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaPuda_ViewModel_TPEmail_Zadejte_kontaktní_e_mail_žadatele_KontaktniEmail")]
        ...
        /*[RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaPuda_ViewModel_TPUlice_Zadejte_název_ulice_trvalého_bydliště_žadatele")]*/
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", true, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaPuda_ViewModel_Zadejte_kraj")]
        ...
        [Display(GroupName = "Podnik", Name = "Velikost podniku")]
        public string VelikostPodniku { get; set; }

        [Display(GroupName = "Podnik", Name = "Počet zaměstnanců")]
        [RegularExpression("^[0-9]*$", ErrorMessage = "Nesprávná hodnota")]
        public int PocetZamestnancu { get; set; }

        [Display(GroupName = "Podnik", Name = "Obrat")]
        [RegularExpression("^[0-9]*$", ErrorMessage = "Nesprávná hodnota")]
        public int Obrat { get; set; }

        [Display(GroupName = "Podnik", Name = "Bilanční suma")]
        [RegularExpression("^[0-9]*$", ErrorMessage = "Nesprávná hodnota")]
