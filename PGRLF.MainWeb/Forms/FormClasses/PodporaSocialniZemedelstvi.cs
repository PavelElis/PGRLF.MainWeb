...
{
    [Serializable]
    public class PodporaSocialniZemedelstvi : AbstractForm
    {

        public PodporaSocialniZemedelstvi()
        {
        ...
        public bool JeUrocnyInvesticniUver { get; set; }
        public bool JeUrocnyProvozniUver { get; set; }
        public bool JeSnizeniJistinyInvesticniUver { get; set; }
        public bool JeSnizeniJistinyProvozniUver { get; set; }

        [Display(ResourceType = typeof(FormResources), Name = "PozadovanaVyseUveru1")]
        [Required(ErrorMessageResourceType = typeof(FormResources), ErrorMessageResourceName = "Nevyplneno_PozadovanaVyseUveru1")]
        public string PozadovanaVyseUveru1 { get; set; }

        [Display(ResourceType = typeof(FormResources), Name = "PozadovanaVyseUveru2")]
        [Required(ErrorMessageResourceType = typeof(FormResources), ErrorMessageResourceName = "Nevyplneno_PozadovanaVyseUveru2")]
        public string PozadovanaVyseUveru2 { get; set; }

        [Display(ResourceType = typeof(FormResources), Name = "DobaSplatnostiInvesticnihoUveru")]
        [Required(ErrorMessageResourceType = typeof(FormResources), ErrorMessageResourceName = "Nevyplneno_DobaSplatnostiInvesticnihoUveru")]
        public string DobaSplatnostiInvesticnihoUveru { get; set; }

        [Display(ResourceType = typeof(FormResources), Name = "DobaSplatnostiProvoznihoUveru")]
        [Required(ErrorMessageResourceType = typeof(FormResources), ErrorMessageResourceName = "Nevyplneno_DobaSplatnostiProvoznihoUveru")]
        public string DobaSplatnostiProvoznihoUveru { get; set; }
