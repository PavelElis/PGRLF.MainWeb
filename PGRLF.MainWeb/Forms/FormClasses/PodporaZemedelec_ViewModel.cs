...
{
    [Serializable]
    public class PodporaZemedelec_ViewModel : AbstractForm
    {
        public PodporaZemedelec_ViewModel()
        {
        ...
        [Display(GroupName = "header", ResourceType = typeof(FormResources), Name = "PodporaZemedelec_PlatceDPH")]
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName = "PodporaZemedelec_ViewModel_PopisneCislo")]
        [Display(GroupName = "fyzickaOsoba", ResourceType = typeof(FormResources),
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaZemedelec_ViewModel_TPEmail_Zadejte_kontaktní_e_mail_žadatele_KontaktniEmail")]
    ...
    ErrorMessageResourceName = "PodporaZemedelec_Povolené_znaky")]
        ...
        /*[RequiredIfFieldHasValue("IsPravnickaOsoba", false, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaZemedelec_ViewModel_TPUlice_Zadejte_název_ulice_trvalého_bydliště_žadatele")]*/
        ...
        [RequiredIfFieldHasValue("IsPravnickaOsoba", true, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName =
                "PodporaZemedelec_ViewModel_Zadejte_kraj")]
        ...
        [Required(ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName = "PodporaZemedelec_ZadajteNazovBanky")]
        [Display(GroupName = "spolecnaCast", ResourceType = typeof(FormResources),
            Name = "PodporaZemedelec_BankovniSpojeni")]
        ...
        [RequiredIfFieldHasValue("RostlinnaVyroba", true, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName = "PodporaZemedelec_ViewModel_StrukturaPestovanychPlodin_Popište_strukturu_pěstovaných_plodin")]
        [UIHint("Textarea")]
        ...
        [RequiredIfFieldHasValue("ZivocisnaVyroba", true, ErrorMessageResourceType = typeof(FormResources),
            ErrorMessageResourceName = "PodporaZemedelec_ViewModel_StrukturaChovanychZvirat_Popište_strukturu_chovaných_zvířat")]
        [UIHint("Textarea")]
        ...
        [UIHint("Textarea")]
        public string VyrobaOkenADveri { get; set; }
        ...
        {
            var form = new PDFform(HttpContext.Current.Server.MapPath("~/Content/FormTemplates/ProgramZemedelecNew.pdf"));
            MemoryStream ms = new MemoryStream();
            Dictionary<string, string> formValues = new Dictionary<string, string>();

            formValues.Add("HEPlatceDPH", PlatceDph ? "      XX" : "XX");
            formValues.Add("HENavyseni", NavyseniMladehoZemedelce ? "      XX" : "XX");
            ...
            formValues.Add("Vydal", Vydal ?? "");
            formValues.Add("DatumZapisu", DatumZapisu != null ? DatumZapisu.Value.ToString("dd.MM.yyyy") : "");
            ...
            formValues.Add("BankovniSpojeni", BankovniSpojeni ?? "");
            ...
            formValues.Add("VyrobaOkenADveri", VyrobaOkenADveri ?? "");
        ...
        {
            var form = new PDFform(HttpContext.Current.Server.MapPath("~/Content/FormTemplates/ProgramZemedelec.pdf"));
            MemoryStream ms = new MemoryStream();
            Dictionary<string, string> formValues = new Dictionary<string, string>();
            ...
            formValues.Add("DatumProdeje", DatumProdeje != null ? DatumProdeje.Value.ToString("MM yyyy") : "");
            formValues.Add("F[0].P2[0].po_banka_nazev[0]", BankovniSpojeni ?? "");
            ...
            formValues.Add("F[0].P3[0].zamereni_vyroby[0]", VyrobaOkenADveri ?? "");
